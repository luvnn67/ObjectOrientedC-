/** Random_Number_Function.cpp
 *	
 *	In this program, we will generate scaled random numbers with a function.
 *	   
...
/**	ScaledRandomNumber function
 *	@param		MINIMUM the minimum random value desired
 *	@param		MAXIMUM the maximum random value desired
 *	@return		a pseudo-random number in the specified range
*/
inline int ScaledRandomNumber(const int MINIMUM = 0, const int MAXIMUM = RAND_MAX)
{
...
int main()
{
	...
	cout << "Random Numbers Function" << endl
		 << "=======================" << endl
	...
	{
		// Call the ScaledRandomNumber function
		randomValue = ScaledRandomNumber(MIN_VALUE, MAX_VALUE);
